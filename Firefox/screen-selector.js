...
(() => {
  console.log('Screen selector script iniciado');
  
  // Evitar múltiples inyecciones
  if (window.__screenSelectorActive) {
    console.log('Screen selector ya activo, saliendo');
    return;
  }
  window.__screenSelectorActive = true;
  console.log('Screen selector activado');
  ...
  // Inicializar
  console.log('Inicializando UI del screen selector');
  const elements = createUI();
  setupEventHandlers(elements);
  console.log('Screen selector completamente inicializado');
})();